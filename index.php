...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="https://mail.google.com/mail/u/5/#inbox">ProminenceHotel@gmail.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>09216144583</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">PROMI <span>NENCE</span><p class="logo_w3l_agile_caption">Your Dreamy Hotel</p></a></h1>
				</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">PROMINENCE</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our Prominence</h3> 
...
<div class="team" id="team">
	<div class="container">
			...
			<div id="horizontalTab">
					...
					<li>
						<img src="images/JAY.jpg" alt=" " class="img-responsive" />
						<div class="col-md-6 team-Info-agileits">
							<h4>Irvy jay Alicaycay</h4>
							<span>Manager</span>
					...
					<li>
						<img src="images/DANIEL.jpg" alt=" " class="img-responsive" />
						<div class="col-md-6 team-Info-agileits">
							<h4>Daniel Castro</h4>
							<span>Receptionist</span>
							<p>Never Give up! Just Do it!.</p>	
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
								<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
					...
					<li>
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Karl laurence Lopres</h4>
							<span>Manager</span>
							<p> Be Strong and Courageous. <br>Opportunities don't happen. You create them.</p>
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
								<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
					...
					<li>
						<img src="images/kent.jpg" alt=" " class="img-responsive" />
						<div class="col-md-6 team-Info-agileits">
							<h4>Kent Gahum</h4>
							<span>Receptionist</span>
					...
					<div class="price-block agile">
						...
						<div class="price-gd-bottom">
							...
							<div class="price-selet">	
								<h6>Original price: <span>Php</span> 10,000</h6>
								<br/>
								<h4><span> Php</span> 9,000</h4>						
				...
				<div class="col-md-3 price-grid ">
					<div class="price-block agile">
						...
						<div class="price-gd-bottom">
							...
							<div class="price-selet">
								<h6>Original price: <span>Php</span> 9,500</h6>
								<br/>
								<h4><span> Php</span> 8,000</h4>
								<a href="admin/reservation.php" >Book Now</a>
							</div>
						</div>
					</div>
				...
				<div class="col-md-3 price-grid lost">
					<div class="price-block agile">
						...
						<div class="price-gd-bottom">
							...
							<div class="price-selet">
								<h6>Original price: <span>Php</span> 8,500</h6>
								<br/>
								<h4><span> Php</span> 7,000</h4>
								<a href="admin/reservation.php" >Book Now</a>
							</div>
						</div>
					</div>
				...
				<div class="col-md-3 price-grid wthree lost">
					<div class="price-block agile">
						...
						<div class="price-gd-bottom">
							...
							<div class="price-selet">
								<h6>Original price: <span>Php</span> 5,000</h6>
								<br/>
								<h4><span> Php</span> 3,000</h4>
								<a href="admin/reservation.php" >Book Now</a>
							</div>
						</div>
					</div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
			...
			<div class="contact-agileits">
				...
				<form  method="post" name="sentMessage" id="contactForm" >
                    ...
                    <div class="control-group form-group">
							...
							<p class="help-block"></p>
						 <textarea name="report" class="form-control" rows="6" cols="50" required></textarea>
                    </div>
				...
				if(isset($_POST['sub']))
				{
					...
					$sql = "INSERT INTO `contact`(`fullname`, `phoneno`, `email`,`report`,`cdate`,`approval`) VALUES ('$name','$phone','$email','report',now(),'$approval')" ;
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>09216144583</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">ProminenceHotel@gmail.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Batasan Hills, Quezon City, Philippines</p>
			...
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d30876.30141349685!2d121.08008727282255!3d14.682158844021403!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397ba1babc8da7d%3A0x50372c6c70a4e868!2sBatasan%20Hills%2C%20Quezon%20City%2C%20Metro%20Manila!5e0!3m2!1sen!2sph!4v1611219573986!5m2!1sen!2sph" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
		</div>
		<div class="clearfix"></div>
	</div>
</section>
<!-- /contact -->
			<div class="copy">
		        <p>© 2021 PROMINENCE . All Rights Reserved | Design by <a href="index.php">PROMINENCE</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
