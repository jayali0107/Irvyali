            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
					 ...
					 <li>
                        <a href="paymentproses.php"><i class="fa fa-qrcode"></i> Payment Proses</a>
                    </li>
                    <li>
									...
									<?php
										while($row = mysqli_fetch_array($re))
										{
											...
											if($id % 2 ==1 )
											{
												...
												<td><a href=paymentproses.php?pid=".$id ." <button class='btn btn-primary'> <i class='fa fa-print' ></i> Pay</button></td>
													<td><a href=checkdel.php?eid=".$id ." <button class='btn btn-danger'> <i class='fa fa-edit' ></i> Check Out</button></td>
												</tr>";
											}
											else
											{
